...
public class SystemController implements ControllerInterface {
	 ...
	 * 
	 */
	public void addNewMember(String memberId, String firstName,String lastName, String telNumber, Address addr) throws LibrarySystemException {
	 ...
	 * book to storage
	 */
	 public boolean addBook(String isbn, String title, int maxCheckoutLength,ArrayList<Author> authors)
